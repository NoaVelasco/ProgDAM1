 ...
 * @author dam1
 */
public class VentanaNac extends JFrame {
...
//    private JPanel panelBotones;
    ...
    public VentanaNac(Controlador controlador, VentanaPrincipal windowMain) {
...
//        add(panelBotones, BorderLayout.SOUTH);
    ...
    private void ordenar(){
        listEmp.sort((a1, a2) -> Integer.compare(a1.getAnio(), a2.getAnio()));
    }
